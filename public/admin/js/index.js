...
var chart = AmCharts.makeChart("analyticsAge", {
    ...
    "theme": "light",
    "dataLoader": {
        "url": "/admin/data/demo-analytics-age.json",
        "format": "json",
        "showErrors": true,
        "noStyles": true,
        "async": true,
...
var analyticsTraffic = AmCharts.makeChart("analyticsTraffic", {
    ...
    "theme": "light",
    "dataLoader": {
        "url": "/admin/data/live-analytics-traffic.json",
        "showCurtain": false
    },
    "titleField": "source",
    "valueField": "count",
...
var mapData = (function() {
    ...
    $.ajax({
        'async': false,
        'global': false,
        'url': '/admin/data/live-analytics-country.json',
        'dataType': "json",
...
AmCharts.ready(function() {
    ...
    map.addTitle(document.getElementById('map-title').innerText, 14);
    map.areasSettings = {
