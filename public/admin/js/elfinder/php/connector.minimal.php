...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => __DIR__.'/../../../../_upload/',                 // path to files (REQUIRED)
			...
			'uploadAllow'   => array('image', 'text/plain', 'application/pdf', 'application/vnd.ms-office', 'application/msword', 'application/vnd.ms-word', 'application/vnd.ms-excel', 'application/vnd.ms-powerpoint', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'),// Mimetype `image` and `text/plain` allowed to upload
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => __DIR__.'/../../../../_upload/.trash/',
			'tmbURL'        => __DIR__.'/../../../../_upload/.trash/.tmb/',
	
		
	
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // Recomend the same settings as the original volume that uses the trash
			'uploadAllow'   => array('image', 'text/plain', 'application/pdf', 'application/vnd.ms-office', 'application/msword', 'application/vnd.ms-word', 'application/vnd.ms-excel', 'application/vnd.ms-powerpoint', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'),// Same as above
