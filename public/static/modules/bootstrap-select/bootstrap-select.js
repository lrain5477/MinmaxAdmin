    ...
    Selectpicker.prototype = {
      ...
      createDropdown: function () {
        ...
        var drop =
            ...
            '<button type="button" class="' + this.options.styleBase + ' dropdown-toggle" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown"' + autofocus + ' role="button" aria-labelledby="'+this.$element.attr("aria-labelledby")+'">' +
            ...
            searchbox +
            actionsbox +
            '<ul class="dropdown-inner inner list-unstyled" role="listbox" aria-expanded="false">' +
            '</ul>' +
            donebutton +
            '</div>' +
            '</div>';
      ...
      liHeight: function (refresh) {
        ...
        menuInner.className = 'dropdown-inner inner';
