...
var chart = AmCharts.makeChart("analyticsAge", {
    ...
    "theme": "light",
    "dataLoader": {
        "url": "data/demo-analytics-age.json",
        "format": "json",
        "showErrors": true,
        "noStyles": true,
        "async": true,
...
var analyticsAll = AmCharts.makeChart("analyticsAll", {
    "type": "serial",
    "dataLoader": {
        "url": "data/demo-analytics-all.json",
        "format": "json",
        "showErrors": true,
        "noStyles": true,
        "async": true
...
var analyticsTraffic = AmCharts.makeChart("analyticsTraffic", {
    ...
    "theme": "light",
    "dataLoader": {
        "url": "data/demo-analytics-traffic.json",
        "showCurtain": false
    },
    "titleField": "country",
    "valueField": "litres",
...
var traffic1 = AmCharts.makeChart("traffic1", {
    ...
    "theme": "light",
    "dataLoader": {
        "url": "data/demo-analytics-traffic1.json",
        "showCurtain": false
    },
...
var traffic2 = AmCharts.makeChart("traffic2", {
    ...
    "theme": "light",
    "dataLoader": {
        "url": "data/demo-analytics-traffic2.json",
        "showCurtain": false
    },
...
var traffic3 = AmCharts.makeChart("traffic3", {
    ...
    "theme": "light",
    "dataLoader": {
        "url": "data/demo-analytics-traffic3.json",
        "showCurtain": false
    },
