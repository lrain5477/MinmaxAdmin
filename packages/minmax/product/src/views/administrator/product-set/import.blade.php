        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <div class="custom-file">
                    ...
                    <label class="custom-file-label" id="ProductSet-file-label" for="ProductSet-file">@lang('MinmaxBase::administrator.form.file.default_text')</label>
                </div>
            </div>
            <small class="form-text text-muted ml-sm-auto col-sm-10">@lang('MinmaxProduct::io.ProductSet.import.hint.file', ['link' => langRoute('administrator.io-data.example', ['id' => $formData->id])])</small>
        </div>
    ...
    $(function() {
        $('#ProductSet-file').on('change', function() {
            if (this.files.length > 0) {
                ...
                $('#ProductSet-file-label').text('@lang('MinmaxBase::administrator.form.file.default_text')');
            }
        });
    });
})(jQuery);
