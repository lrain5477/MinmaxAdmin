...
<div class="form-group row">
    ...
    <div class="col-sm-{{ $size }}">
        <select class="bs-select form-control"
                id="{{ $id }}"
                name="{{ $name }}"
                title="@lang('MinmaxProduct::admin.form.ProductSet.please_select')"
                data-size="6"
                data-live-search="true"
                data-actions-box="true"
                data-select-all-text="@lang('MinmaxBase::admin.form.select_all')"
                data-deselect-all-text="@lang('MinmaxBase::admin.form.select_clear')"
                multiple
                required>
