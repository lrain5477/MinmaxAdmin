...
@section('action-buttons')
    @component('MinmaxBase::admin.layouts.right-links', ['languageActive' => $languageActive])
        @if($adminData->can('articleNewsShow'))
...
@section('forms')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getFieldMultiSelect($formData, 'categories', ['size' => 5, 'type' => 'dropdown', 'hint' => true, 'defaultValue' => $formData->articleCategories->pluck('id')->toArray()]) !!}
