...
Route::group([
    ...
    Route::group(['prefix' => 'administrator', 'namespace' => 'Minmax\World\Administrator', 'middleware' => 'auth:administrator'], function () {
        /*
         |--------------------------------------------------------------------------
         | 需要登入的路由。
         |--------------------------------------------------------------------------
         ...
         * WorldLanguage 語系管理
         */
        Route::get('world-language', 'WorldLanguageController@index')->name('world-language.index');
        Route::post('world-language', 'WorldLanguageController@store')->name('world-language.store');
        Route::get('world-language/create', 'WorldLanguageController@create')->name('world-language.create');
        Route::get('world-language/{id}', 'WorldLanguageController@show')->name('world-language.show');
        Route::put('world-language/{id}', 'WorldLanguageController@update')->name('world-language.update');
        Route::delete('world-language/{id}', 'WorldLanguageController@destroy')->name('world-language.destroy');
        Route::get('world-language/{id}/edit', 'WorldLanguageController@edit')->name('world-language.edit');
        Route::post('world-language/ajax/datatables', 'WorldLanguageController@ajaxDataTable')->name('world-language.ajaxDataTable');
        Route::patch('world-language/ajax/switch', 'WorldLanguageController@ajaxSwitch')->name('world-language.ajaxSwitch');
        Route::patch('world-language/ajax/sort', 'WorldLanguageController@ajaxSort')->name('world-language.ajaxSort');
