 ...
 * @var \Minmax\World\Models\WorldCountry $formData
 */
?>
...
@section('action-buttons')
    @component('MinmaxBase::admin.layouts.right-links', ['languageActive' => $languageActive])
        @if($adminData->can('worldCountryShow'))
        ...
        @endif
        @if($adminData->can('worldCountryEdit'))
...
@section('views')
    @inject('modelPresenter', 'Minmax\World\Admin\WorldCountryPresenter')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getViewSelection($formData, 'continent_id') !!}
        ...
        {!! $modelPresenter->getViewSelection($formData, 'language_id') !!}
