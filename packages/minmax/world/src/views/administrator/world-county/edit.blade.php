 ...
 * @var \Minmax\World\Models\WorldCounty $formData
 */
?>
...
@section('forms')
    @inject('modelPresenter', 'Minmax\World\Administrator\WorldCountyPresenter')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getFieldSelect($formData, 'state_id', ['required' => true]) !!}
