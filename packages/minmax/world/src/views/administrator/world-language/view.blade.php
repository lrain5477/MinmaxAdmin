...
@section('views')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getViewNormalText($formData, 'native') !!}

        {!! $modelPresenter->getViewNormalText($formData, 'options', ['subColumn' => 'icon']) !!}

        {!! $modelPresenter->getViewNormalText($formData, 'options', ['subColumn' => 'script']) !!}

        {!! $modelPresenter->getViewNormalText($formData, 'options', ['subColumn' => 'regional']) !!}
    ...
    <fieldset class="mt-4" id="advFieldSet">
        ...
        {!! $modelPresenter->getViewSelection($formData, 'active_admin') !!}
