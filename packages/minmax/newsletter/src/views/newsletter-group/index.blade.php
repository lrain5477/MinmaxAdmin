<?php
/**
 * List page of model NewsletterGroup
 *
...
@if($adminData->can('newsletterGroupCreate'))
...
<table class="table table-responsive-md table-bordered table-striped table-hover table-checkable datatables" id="tableList">
    <thead>
    <tr role="row">
        <th class="w-50">@lang('models.NewsletterGroup.title')</th>
        <th>@lang('models.NewsletterGroup.created_at')</th>
