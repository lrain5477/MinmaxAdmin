...
class ElfinderController extends Controller
{
    ...
    {
        try {
            return view($this->packagePrefix . 'admin.layouts.elfinder.elfinder', $this->getViewVars());
        } catch (\Exception $e) {
            return abort(404);
        }
    }
    ...
    {
        try {
            return view($this->packagePrefix . 'admin.layouts.elfinder.tinymce', $this->getViewVars());
        } catch (\Exception $e) {
            return abort(404);
        }
    }
    ...
    {
        try {
            return view($this->packagePrefix . 'admin.layouts.elfinder.tinymce4', $this->getViewVars());
        } catch (\Exception $e) {
            return abort(404);
        }
    }
    ...
    {
        try {
            return view($this->packagePrefix . 'admin.layouts.elfinder.ckeditor4', $this->getViewVars());
        } catch (\Exception $e) {
            return abort(404);
        }
    }
    ...
    {
        try {
            return view($this->packagePrefix . 'admin.layouts.elfinder.standalonepopup', $this->getViewVars())
    ...
    public function showFilePicker($input_id)
    {
        ...
        try {
            return view($this->packagePrefix . 'admin.layouts.elfinder.filepicker', $this->getViewVars())
