...
@section('forms')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getFieldText($formData, 'table_name', ['required' => true]) !!}

        {!! $modelPresenter->getFieldText($formData, 'column_name', ['required' => true]) !!}

        {!! $modelPresenter->getFieldText($formData, 'sub_column_name', ['required' => true]) !!}

        {!! $modelPresenter->getFieldText($formData, 'title', ['required' => true]) !!}

        {!! $modelPresenter->getFieldDynamicOptionText($formData, 'options', ['required' => true, 'hint' => true, 'defaultValue' => ['method' => 'getFieldText']]) !!}
