 ...
 * @var \Minmax\Base\Models\Permission $formData
 */
?>
...
@section('forms')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getFieldText($formData, 'group', ['required' => true]) !!}

        {!! $modelPresenter->getFieldText($formData, 'name', ['required' => true]) !!}

        {!! $modelPresenter->getFieldText($formData, 'label', ['required' => true]) !!}

        {!! $modelPresenter->getFieldText($formData, 'display_name', ['required' => true]) !!}
