...
@inject('modelPresenter', 'Minmax\Base\Administrator\SystemParameterGroupPresenter')

@section('grid-filter')
    @component('MinmaxBase::administrator.layouts.grid.filter-keyword')
    <option value="title">@lang('MinmaxBase::models.SystemParameterGroup.title')</option>
    <option value="code">@lang('MinmaxBase::models.SystemParameterGroup.code')</option>
    @endcomponent

    @component('MinmaxBase::administrator.layouts.grid.filter-equal')
    {!! $modelPresenter->getFilterSelection('active', 'searchActive', ['emptyLabel' => __('MinmaxBase::models.SystemParameterGroup.active')]) !!}
    @endcomponent
@endsection
...
<table class="table table-responsive-md table-bordered table-striped table-hover table-checkable datatables" id="tableList">
    <thead>
    <tr role="row">
        <th class="w-25">@lang('MinmaxBase::models.SystemParameterGroup.title')</th>
        <th class="w-25">@lang('MinmaxBase::models.SystemParameterGroup.code')</th>
        <th>@lang('MinmaxBase::models.SystemParameterGroup.active')</th>
