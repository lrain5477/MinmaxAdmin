...
@section('views')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getViewSelection($formData, 'options', ['subColumn' => 'target']) !!}

        {!! $modelPresenter->getViewSelection($formData, 'permission_key') !!}
    ...
    <fieldset class="mt-4" id="advFieldSet">
        ...
        {!! $modelPresenter->getViewSelection($formData, 'editable') !!}
