...
<div class="page-header fixed-top">
    ...
    <div class="top-right pr-2 mt-1">
        ...
        <div class="d-inline-block dropdown globe">
            <button class="btn btn-link text-secondary dropdown-toggle px-2" id="menu-globe" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-globe h4"></i><span class="text-hide">>@lang('MinmaxBase::admin.header.language')</span></button>
        ...
        @endif
        <div class="d-inline-block dropdown globe">
            <button class="btn btn-link text-secondary dropdown-toggle px-2" id="menu-profile" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-user h4"></i><span class="text-hide">>@lang('MinmaxBase::admin.header.account')</span></button>
            <div class="dropdown-menu dropdown-menu-right rounded-0" aria-labelledby="menu-profile">
                <a class="dropdown-item" href="{{ langRoute('admin.profile') }}"><i class="icon-vcard"></i><span>@lang('MinmaxBase::admin.header.profile')</span></a>
                <a class="dropdown-item" href="{{ langRoute('admin.logout') }}"><i class="icon-log-out"></i><span>@lang('MinmaxBase::admin.header.logout')</span></a>
            </div>
        </div>
    </div>
</div>