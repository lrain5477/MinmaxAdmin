...
<body>
<div class="wrapper">
    @include('MinmaxBase::admin.layouts.header')
    ...
    <div class="border-box page-content">
        ...
        <div class="content-body">
            @include('MinmaxBase::admin.layouts.alerts')

            @yield('content')
        </div>
    </div>

    @include('MinmaxBase::admin.layouts.sidebar')
...
@include('MinmaxBase::admin.layouts.plugin')
</body>
</html>