...
class MinmaxControllerCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'minmax:controller';
    ...
    protected function replaceNamespace(&$stub, $name)
    {
        ...
        if ($inputPackage == 'app') {
            $repositoryNamespace = str_replace('\\Http\\Controllers\\', '\\Repositories\\', $this->getNamespace($name));
        } else {
            $repositoryNamespace = $this->getNamespace($name);
        }

        $stub = str_replace(
            ['DummyNamespace', 'DummyRootNamespace', 'DummyBaseNamespace', 'DummyRepositoryNamespace'],
            [$this->getNamespace($name), $this->rootNamespace(), $baseNamespace, $repositoryNamespace],
            $stub
        );
    ...
    protected function replaceClass($stub, $name)
    {
        ...
        $repositoryClass = preg_replace('/Controller$/i', 'Repository', $class);

        return str_replace(
            ['DummyClass', 'DummyRepositoryClass'],
