    ...
    public function insertDatabase()
    {
        ...
        $columnExtensionData = [
            ...
            ['table_name' => 'web_data', 'column_name' => 'contact', 'sub_column_name' => 'phone', 'sort' => 1, 'active' => true,
                'title' => 'column_extension.title.4', 'options' => json_encode(['method' => 'getFieldText', 'required' => true, 'type' => 'tel'])],
            ['table_name' => 'web_data', 'column_name' => 'contact', 'sub_column_name' => 'fax', 'sort' => 2, 'active' => false,
                'title' => 'column_extension.title.5', 'options' => json_encode(['method' => 'getFieldText', 'type' => 'tel'])],
            ['table_name' => 'web_data', 'column_name' => 'contact', 'sub_column_name' => 'email', 'sort' => 3, 'active' => true,
                'title' => 'column_extension.title.6', 'options' => json_encode(['method' => 'getFieldText', 'required' => true, 'type' => 'email'])],
