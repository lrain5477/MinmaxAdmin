...
@section('views')
    ...
    <fieldset id="baseFieldSet">
        ...
        {!! $modelPresenter->getViewSelection($formData, 'import_enable') !!}

        {!! $modelPresenter->getViewNormalText($formData, 'import_view') !!}

        {!! $modelPresenter->getViewSelection($formData, 'export_enable') !!}

        {!! $modelPresenter->getViewNormalText($formData, 'export_view') !!}

        {!! $modelPresenter->getViewNormalText($formData, 'controller') !!}

        {!! $modelPresenter->getViewNormalText($formData, 'example') !!}

        {!! $modelPresenter->getViewNormalText($formData, 'filename') !!}
