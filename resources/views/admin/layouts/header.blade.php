    ...
    <div class="top-right pr-2 mt-1">
        ...
        <div class="d-inline-block dropdown globe">
            ...
            <div class="dropdown-menu dropdown-menu-right rounded-0" aria-labelledby="menu-profile">
                <a class="dropdown-item" href="{{ langRoute('admin.profile') }}"><i class="icon-vcard"></i><span>@lang('admin.header.profile')</span></a>
                <a class="dropdown-item" href="{{ langRoute('admin.logout') }}"><i class="icon-log-out"></i><span>@lang('admin.header.logout')</span></a>
            </div>
        </div>
    </div>
</div>