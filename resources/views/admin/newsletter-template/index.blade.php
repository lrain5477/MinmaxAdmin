...
@if($adminData->can('newsletterTemplateCreate'))
...
<table class="table table-responsive-md table-bordered table-striped table-hover table-checkable datatables" id="tableList">
    <thead>
    <tr role="row">
        <th>@lang('models.NewsletterTemplate.title')</th>
        <th>@lang('models.NewsletterTemplate.subject')</th>
        <th>@lang('models.NewsletterTemplate.created_at')</th>
