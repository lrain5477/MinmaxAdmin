<div class="form-group row">
    ...
    <div class="col-sm-10">
        ...
        <button class="btn btn-secondary" type="button" data-target="#{{ $id }}-modal" data-toggle="modal"><i class="icon-folder"> </i> @lang('administrator.form.button.media_file')</button>
    </div>
    @if($hint !== '')
