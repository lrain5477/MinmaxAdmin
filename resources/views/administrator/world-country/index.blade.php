    ...
    <div class="datatableFilter row no-gutters justify-content-end text-nowrap">
        ...
        <div class="col col-md-auto ml-1">
            <select class="bs-select form-control sch_select" id="searchActive" name="searchActive" data-style="btn-outline-light btn-sm">
                ...
                <option value="1">@lang('models.WorldCountry.selection.active.1')</option>
                <option value="0">@lang('models.WorldCountry.selection.active.0')</option>
            </select>
        </div>
    </div>
</div>
...
<table class="table table-responsive-md table-bordered table-striped table-hover table-checkable datatables" id="tableList">
    <thead>
    <tr role="row">
        <th>@lang('models.WorldCountry.title')</th>
        <th>@lang('models.WorldCountry.name')</th>
        <th>@lang('models.WorldCountry.code')</th>
        <th>@lang('models.WorldCountry.active')</th>
