...
@section('content')
    ...
    <section class="panel panel-default">
        <header class="panel-heading">
            <h1 class="h5 float-left font-weight-bold">@lang('administrator.header.account') @lang('administrator.form.edit')</h1>
        </header>
        ...
        <div class="panel-wrapper">
            <div class="panel-body">
                <form id="editForm" class="form-horizontal validate editForm"  name="editForm"
                    ...
                    @inject('modelPresenter', 'App\Presenters\Administrator\AdministratorPresenter')

                    <fieldset id="baseFieldSet">
                        <legend class="legend h6 mb-4"><i class="icon-angle-double-down2 mr-2"></i>@lang('administrator.form.fieldSet.default')</legend>

                        {!! $modelPresenter->getFieldNormalText($formData, 'username') !!}
                    ...
                    <fieldset class="mt-4" id="advFieldSet">
                        ...
                        {!! $modelPresenter->getFieldTextarea($formData, 'allow_ip', ['hint' => true]) !!}
