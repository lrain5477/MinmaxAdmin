    ...
    <div class="datatableFilter row no-gutters justify-content-end text-nowrap">
        ...
        <div class="col col-md-auto ml-1">
            <select class="bs-select form-control sch_select" id="searchActive" name="searchActive" data-style="btn-outline-light btn-sm">
                ...
                <option value="1">@lang('models.AdminMenuItem.selection.active.1')</option>
                <option value="0">@lang('models.AdminMenuItem.selection.active.0')</option>
            </select>
        </div>
    </div>
</div>
...
<table class="table table-responsive-md table-bordered table-striped table-hover table-checkable datatables" id="tableList">
    <thead>
    <tr role="row">
        <th>@lang('models.AdminMenuItem.title')</th>
        <th>@lang('models.AdminMenuItem.uri')</th>
        <th>@lang('models.AdminMenuItem.model')</th>
        <th>@lang('models.AdminMenuItem.class')</th>
        <th>@lang('models.AdminMenuItem.parent')</th>
        <th>@lang('models.AdminMenuItem.sort')</th>
        <th>@lang('models.AdminMenuItem.active')</th>
